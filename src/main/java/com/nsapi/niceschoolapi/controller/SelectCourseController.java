...
public class SelectCourseController {
    ...
    @ResponseBody
    public Object index(Integer page, Integer limit, SelCourseVO selCourseVO){
...
public Object selcourse(StuCourseDB stuCourseDB, CourseDB courseDB, SelCourseVO selCourseVO){
    String msg="";
